    ...
    public partial class ReservationInit_20251230 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Warszawa", null, "Artistic Studio", "Polska", "Nowoczesny salon fryzjerski z wieloletnim doświadczeniem", "kontakt@artisticstudio.pl", null, "+48123456789", "00-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4187), "ul. Główna", "15", "https://artisticstudio.pl" },
                    { 2, null, "Warszawa", null, "Barber Craft", "Polska", "Męski barber shop z tradycyjnym podejściem do stylizacji", "kontakt@barbercraft.pl", null, "+48222333444", "00-120", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4190), "ul. Męska", "10", "https://barbercraft.pl" },
                    { 3, null, "Kraków", null, "Beauty Glamour", "Polska", "Profesjonalne studio urody i kosmetyki", "kontakt@beautyglamour.pl", null, "+48333444555", "30-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4192), "ul. Piękna", "5", "https://beautyglamour.pl" },
                    { 4, null, "Kraków", null, "Wellness Spa", "Polska", "Centrum SPA i masażu relaksacyjnego", "info@wellnessspa.pl", null, "+48444555666", "30-045", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4194), "ul. Leśna", "8", "https://wellnessspa.pl" },
                    { 5, null, "Wrocław", null, "Nails Studio", "Polska", "Profesjonalny salon paznokci i stylizacji dłoni", "kontakt@nailsstudio.pl", null, "+48555666777", "50-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4196), "ul. Dłonie", "2", "https://nailsstudio.pl" },
                    { 6, null, "Poznań", null, "Massage Center", "Polska", "Masaże relaksacyjne i zabiegi lecznicze", "kontakt@massagecenter.pl", null, "+48666777888", "60-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4198), "ul. Relaksu", "21", "https://massagecenter.pl" },
                    { 7, null, "Wrocław", null, "Coffee Barber", "Polska", "Barber shop z kawiarnią w stylu industrialnym", "kontakt@coffeebarber.pl", null, "+48777888999", "50-120", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4200), "ul. Kawowa", "7", "https://coffeebarber.pl" },
                    { 8, null, "Gdańsk", null, "Prestige Clinic", "Polska", "Zaawansowane zabiegi kosmetologiczne i medycyny estetycznej", "rejestracja@prestigeclinic.pl", null, "+48888999000", "80-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4201), "ul. Luksusowa", "1", "https://prestigeclinic.pl" },
                    { 9, null, "Łódź", null, "City Hair Studio", "Polska", "Nowoczesny salon fryzjerski w centrum miasta", "kontakt@cityhairstudio.pl", null, "+48999000111", "90-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4203), "ul. Miejska", "11", "https://cityhairstudio.pl" },
                    { 11, null, "Rzeszów", null, "Podkarpackie Barber Shop", "Polska", "Tradycyjny barber shop z nowoczesnym podejściem", "kontakt@podkarpackiebarber.pl", null, "+48171234567", "35-001", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4205), "ul. Rzeszowska", "14", "https://podkarpackiebarber.pl" },
                    { 12, null, "Rzeszów", null, "Beauty Studio Rzeszów", "Polska", "Nowoczesne studio urody z pełną ofertą zabiegów", "info@beautystudiorzeszow.pl", null, "+48172345678", "35-010", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4207), "ul. Piłsudskiego", "22", "https://beautystudiorzeszow.pl" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Oddział główny", "Warszawa", null, 1, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4485), null, "00-001", "ul. Główna", "15" },
                    { 2, null, "Oddział główny", "Warszawa", null, 2, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4487), null, "00-120", "ul. Męska", "10" },
                    { 3, null, "Oddział główny", "Kraków", null, 3, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4488), null, "30-001", "ul. Piękna", "5" },
                    { 4, null, "Oddział główny", "Kraków", null, 4, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4489), null, "30-045", "ul. Leśna", "8" },
                    { 5, null, "Oddział główny", "Wrocław", null, 5, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4490), null, "50-001", "ul. Dłonie", "2" },
                    { 6, null, "Oddział główny", "Poznań", null, 6, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4492), null, "60-001", "ul. Relaksu", "21" },
                    { 7, null, "Oddział główny", "Wrocław", null, 7, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4493), null, "50-120", "ul. Kawowa", "7" },
                    { 8, null, "Oddział główny", "Gdańsk", null, 8, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4494), null, "80-001", "ul. Luksusowa", "1" },
                    { 9, null, "Oddział główny", "Łódź", null, 9, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4495), null, "90-001", "ul. Miejska", "11" },
                    { 11, null, "Oddział główny", "Rzeszów", null, 11, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4497), null, "35-001", "ul. Rzeszowska", "14" },
                    { 12, null, "Oddział główny", "Rzeszów", null, 12, "Polska", new DateTime(2025, 12, 30, 9, 39, 19, 675, DateTimeKind.Utc).AddTicks(4499), null, "35-010", "ul. Piłsudskiego", "22" }
                });
