...
- `#general` - Ogólna komunikacja
- `#standup` - Daily standupy
- `#backend` - Backend dyskusje
- `#frontend` - Frontend dyskusje
- `#devops` - DevOps i deployment
- `#help` - Pomoc i blokery
...
Zanim zaczniesz zadanie, upewnij się że:
- [ ] Jasno rozumiesz wymagania
- [ ] Masz dostęp do wszystkich potrzebnych zasobów
- [ ] Zależności są gotowe
- [ ] Acceptance criteria są zdefiniowane
...
- [ ] Code review jest zrobione
- [ ] Zmergeowane do develop branch
- [ ] Działa w Docker
...
1. **Najpierw sprawdź:**
   - Dokumentację w `/docs`
   - Logi w kontenerach: `docker logs [container-name]`
   - GitHub Issues

2. **Jeśli blokujesz:**
   - Napisz na #help z opisem problemu
   - Pair programming z kimś z zespołu
   - Daily standup - zgłoś bloker

3. **Emergency contacts:**
   - Team Lead: [telefon/discord]
   - DevOps: [telefon/discord]
